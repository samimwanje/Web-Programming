 ...
 * @param {} url - Url used to get a response from the API server.
 * @returns	- Returns the response from the server, which can later be used.
 */
 ...
 * @param {} url - Used for the URL of the API server the has a POST.
 * @param {*} body - {"answer":"xyz"} // body with the user given answer.
 * @returns  - Returns a response based on how things went.
 */
export async function sendResponse (url, body) {
  const data = {					// data object that is going to be fetched.
